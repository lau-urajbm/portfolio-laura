...
const Portfolio = () => {
  return (
    <div className='container mt-4'>
      <section className='d-flex justify-content-evenly contenedor-all pt-4'>
      ...
      <section id='proyectos' className='pro-sec m-4 p-4' >
        <h2 className='titles'>Mis Proyectos</h2>
        <div className='d-flex m-4'>
        <div id="carouselExampleIndicators1" class="carousel slide w-50" data-bs-ride="true">
  ...
  <div class="carousel-inner ">
    <div class="carousel-item active ">
      <img src={landingDogs} class="d-block w-100 " alt="..."></img>
    </div>
    <div class="carousel-item">
      <img src={homeDogs} class="d-block w-100" alt="..."></img>
    </div>
    <div class="carousel-item">
      <img src={creationDogs}class="d-block w-100" alt="..."></img>
    </div>
  </div>
...
<div className='d-flex m-4'>
        <div id="carouselExampleIndicators2" class="carousel slide w-50" data-bs-ride="true">
  <div class="carousel-indicators">
...
<div className='d-flex m-4'>
        <div id="carouselExampleIndicators3" class="carousel slide w-50" data-bs-ride="true">
  <div class="carousel-indicators">
...
sequelize, jsonwebtoken, entre otros. <br></br>
  ...
  Link de la app:<br></br> <a href=' https://henry-shoes.vercel.app/'> https://henry-shoes.vercel.app/
    ...
    <div className='d-flex m-4'>
        <div id="carouselExampleIndicators4" class="carousel slide w-50" data-bs-ride="true">
  <div class="carousel-indicators">
...
<p>Para este pequeño proyecto utilice react, Bootstrap, Express, postgresql y cloudinary. Permite seleccionar
  ...
  Link del respositorio en gitHub<br></br> <a href=' https://github.com/lau-urajbm/uploader-app'>https://github.com/lau-urajbm/uploader-app
    ...
    <div className='d-flex m-4'>
        <div id="carouselExampleIndicators5" class="carousel slide w-50" data-bs-ride="true">
  <div class="carousel-indicators">
